...
### Complete Mini-Game Example
A combination of all features - drag to move, click to place blocks, with responsive camera:

<PocContainer
  title="Complete Amelcraft Mini-Game"
  codeFile="amelcraftMiniGame.js"
/>
